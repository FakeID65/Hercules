...
I'm a beautiful Group manager bot! Join [Shizuka Minamoto Channel](t.me/ShizukaMinamoto) for getting latest updates and news about bot. I'm built in python3, using the \
python-telegram-bot library \


You can find the list of available commands with /help.

[Click here to add me in your groups](https://telegram.me/ShizukaMinamotoBot?startgroup=add)
